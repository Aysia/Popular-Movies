...
public class TrailerTask extends AsyncTask<String, Void, JSONObject> {
    ...
    public TrailerTask(TaskListener listener) {
    ...
    protected JSONObject doInBackground(String... args) {
        final String BASE_URL =
                "http://api.themoviedb.org/3/movie/" + args[0] + "/videos?";
    ...
    protected void onPostExecute(JSONObject jsonObject) {
        ...
        try {
            ...
            taskListener.onFinished(trailers);
